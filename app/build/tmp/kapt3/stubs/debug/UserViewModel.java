...
public final class UserViewModel extends androidx.lifecycle.ViewModel {
    ...
    public final void updatePositionUser(@org.jetbrains.annotations.NotNull()
    com.example.catourneandroid.database.entity.UserEntity user) {
    }
    
    public final void updateIdTeamByUserId(@org.jetbrains.annotations.NotNull()
    com.example.catourneandroid.database.entity.UserEntity user) {
    }
